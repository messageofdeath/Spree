package net.mcpolitics.dev.Spree.Utils.UserManager;

import java.util.ArrayList;

import net.mcpolitics.dev.Spree.Spree;
import net.mcpolitics.dev.Spree.Utils.DonatorManager.DonationType;
